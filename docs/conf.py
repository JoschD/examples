...
project = "Josch's Examples"
copyright = f"2022, {josch_examples.__author__}"
author = josch_examples.__author__

# The full version, including alpha/beta/rc tags
version = josch_examples.__version__
release = josch_examples.__version__


rst_prolog = f"""
:github_url: {josch_examples.__url__}
"""
...
issues_github_path = "joschd/examples"
...
sphinx_gallery_conf = {
    "examples_dirs": ["../josch_examples"],  # directory where to find plotting scripts
...
# html_logo = "_static/img/josch_examples.svg"
...
htmlhelp_basename = "josch_examples_doc"
...
latex_documents = [(master_doc, "josch_examples.tex", "josch_examples Documentation", author, "manual")]
...
man_pages = [(master_doc, "Josch's Examples", "Josch's Examples", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Josch's Examples",
        "josch's Examples Documentation",
        author,
        "Josch's Examples",
        "Some examples made by Josch.",
        "Examples",
    )
]
